...
// Game Variables
var snake = {}; // Object to represent the snake
var apple = {}; // Object to represent the apple
...
function moveSnake() {
  ...
  */
  for (var i = snake.body.length - 1; i > 0; i--) {
    ...
    currentSquare.row = nextSquare.row;
    currentSquare.column = nextSquare.column;
    currentSquare.direction = nextSquare.direction;
  ...
  */
  var head = snake.head;
  if (head.direction === "left") head.column--;
  else if (head.direction === "right") head.column++;
  else if (head.direction === "up") head.row--;
  else if (head.direction === "down") head.row++;
  repositionSquare(head);
}
...
function handleAppleCollision() {
  ...
  */
  ...
  makeSnakeSquare(tail.row, tail.column);
}
  ...
  do {
    ...
    */
    for (var i = 0; i < snake.body.length; i++) {
      var bodyPart = snake.body[i];
      if (bodyPart.row === randomPosition.row && bodyPart.column === randomPosition.column) {
